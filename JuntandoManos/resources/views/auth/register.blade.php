                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="country" name="country" class="form-control">
                                  ...
                                  <option value="Ar">Bolivia</option>
                                  <option value="Ar">Brasil</option>
                                  <option value="Ar">Colombia</option>
                                  <option value="Ar">Chile</option>
                                  <option value="Ar">Costa Rica</option>
                                  <option value="Ar">Cuba</option>
                                  <option value="Ar">Ecuador</option>
                                  <option value="Ar">Honduras</option>
                                  <option value="Ar">Guatemala</option>
                                  <option value="Ar">Mexico</option>
                                  <option value="Ar">Nicaragua</option>
                                  <option value="Ar">Paraguay</option>
                                  <option value="Ar">Panama</option>
                                  <option value="Ar">Peru</option>
                                  <option value="Ar">Uruguay</option>
                                  <option value="Ar">Venezuela</option>
                                </select>
                            </div>
                        </div>
